...
extern float bn1_run_mean_buf[BN1_CHANNELS];
extern float bn2_run_mean_buf[BN2_CHANNELS];
extern float bn3_run_mean_buf[BN3_CHANNELS];
extern float bn4_run_mean_buf[BN4_CHANNELS];
extern float bn5_run_mean_buf[BN5_CHANNELS];

extern float bn1_run_var_buf[BN1_CHANNELS];
extern float bn2_run_var_buf[BN2_CHANNELS];
extern float bn3_run_var_buf[BN3_CHANNELS];
extern float bn4_run_var_buf[BN4_CHANNELS];
extern float bn5_run_var_buf[BN5_CHANNELS];
...
extern float bn_dxnorm_scratch[ALEXNET_STATIC_MAX_BATCH * BN_MAX_UNITS];
