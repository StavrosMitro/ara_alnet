...
void fmatmul_deferred_32(_Float16 *c, const _Float16 *a, const _Float16 *b,
                         const unsigned long int M, const unsigned long int N,
                         const unsigned long int P) {
    fmatmul_4x4_deferred_32(c, a, b, M, N, P);
}
...
void fmatmul_4x4_deferred_32(_Float16 *c, const _Float16 *a, const _Float16 *b,
    ...
    for (unsigned long int p = 0; p < P; p += block_size) {
        ...
        for (unsigned long int m = 0; m < M; m += block_size) {
            ...
            fmatmul_vec_4x4_slice_init_deferred_32();
            fmatmul_vec_4x4_deferred_32(c__, a_, b_, N, P, p_);
        }
    }
}
