...
void load_fc_weights_32(fc_op *op, _Float16 *w_array, _Float16 *b_array)
{
...
void calc_bias_gradient_vec_32(_Float16 *d_bias, const _Float16 *d_output, int out_units, int batchsize)
{
