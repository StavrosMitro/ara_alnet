...
void fmatmul_vec_4x4_slice_init_nt_32() {
...
void fmatmul_vec_8x8_slice_init_nt_32() {
  asm volatile("vmv.v.i v0,  0");
...
void fmatmul_vec_16x16_slice_init_nt_32() {
  asm volatile("vmv.v.i v0,  0");
...
void fmatmul_4x4_nt_32(_Float16 *c, const _Float16 *a, const _Float16 *b,
  ...
  for (unsigned long int p = 0; p < P; p += block_size_p) {
    ...
    for (unsigned long int m = 0; m < M; m += block_size) {
      ...
      fmatmul_vec_4x4_slice_init_nt_32();
...
void fmatmul_8x8_nt_32(_Float16 *c, const _Float16 *a, const _Float16 *b,
  ...
  for (unsigned long int p = 0; p < P; p += block_size_p) {
    ...
    for (unsigned long int m = 0; m < M; m += block_size) {
      ...
      fmatmul_vec_8x8_slice_init_nt_32();
...
void fmatmul_16x16_nt_32(_Float16 *c, const _Float16 *a, const _Float16 *b,
  ...
  for (unsigned long int p = 0; p < P; p += block_size_p) {
    ...
    for (unsigned long int m = 0; m < M; m += block_size) {
      ...
      fmatmul_vec_16x16_slice_init_nt_32();
