...
// INPUTS/OUTPUTS, or the embedded .bin strides won't line up. The apps/Makefile
// does this for you (FC_BENCH_IN_UNITS / FC_BENCH_OUT_UNITS drive both the -D
// flags and the generator).
// Constraints: FC_INPUT_UNITS <= FC_MAX_IN_UNITS, FC_OUTPUT_UNITS <= FC_MAX_INTERNAL.
// Mirrors fc_layer16only/kernel/alexnet.h so the FP32/FP16 pair resizes together;
// these were hardcoded to 128 here, so the app silently ignored the Makefile knob.
// ===========================================================================
...
void alexnet_inference_32(alexnet *net, const unsigned char *img_bytes);
