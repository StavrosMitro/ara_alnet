...
static _Float16 act_fc1[ALEXNET_STATIC_MAX_BATCH * FC_OUTPUT_UNITS];
...
{
    // Expected shape derives from the FC_INPUT_UNITS x FC_OUTPUT_UNITS knob in
    // alexnet.h; weights.c must be generated by scripts/generate_fc_test_vectors.py
